#
# Lab Environment for WSAA module 4
#
...
New-VM -Name $VM1 -MemoryStartupBytes 1536mb -VHDPath ($TargetFolder + $VM1 + ".vhdx") -Generation 2 -SwitchName "NAT vSwitch" | Set-VM -CheckpointType Production -AutomaticCheckpointsEnabled $false -PassThru | Set-VMMemory -DynamicMemoryEnabled $false
New-VM -Name $VM2 -MemoryStartupBytes 1536mb -VHDPath ($TargetFolder + $VM2 + ".vhdx") -Generation 2 -SwitchName "NAT vSwitch" | Set-VM -CheckpointType Production -AutomaticCheckpointsEnabled $false -PassThru | Set-VMMemory -DynamicMemoryEnabled $false
New-VM -Name $VM3 -MemoryStartupBytes 4096mb -VHDPath ($TargetFolder + $VM3 + ".vhdx") -Generation 2 -SwitchName "NAT vSwitch" | Set-VM -CheckpointType Production -AutomaticCheckpointsEnabled $false -PassThru | Set-VMMemory -DynamicMemoryEnabled $false
New-VM -Name $VM4 -MemoryStartupBytes 4096mb -VHDPath ($TargetFolder + $VM4 + ".vhdx") -Generation 2 -SwitchName "NAT vSwitch" | Set-VM -CheckpointType Production -AutomaticCheckpointsEnabled $false -PassThru | Set-VMMemory -DynamicMemoryEnabled $false
...
Add-VMNetworkAdapter -VMName $VM2 -Name "Storage NIC" -SwitchName vStorage
Add-VMNetworkAdapter -VMName $VM3 -Name "Storage NIC" -SwitchName vStorage
Add-VMNetworkAdapter -VMName $VM4 -Name "Storage NIC" -SwitchName vStorage
Add-VMNetworkAdapter -VMName $VM3 -Name "Private NIC" -SwitchName vPrivate
Add-VMNetworkAdapter -VMName $VM4 -Name "Private NIC" -SwitchName vPrivate